<head>
    ...
    @include('App.Layout.style')
    @yield('link')

</head>

<body class="hold-transition light-skin sidebar-mini theme-warning fixed rtl">
        ...
        <div class="d-flex align-items-center logo-box justify-content-start">
            ...
            <a href="#" class="logo">
                ...
                <div class="logo-mini w-30">
                    <span class="light-logo"><img src="https://crypto-admin-templates.multipurposethemes.com/bs5/images/logo-letter.png" alt="logo"></span>
                    <span class="dark-logo"><img src="https://crypto-admin-templates.multipurposethemes.com/bs5/images/logo-letter.png" alt="logo"></span>
                </div>
                <div class="logo-lg">
                    <span class="light-logo"><img src="https://crypto-admin-templates.multipurposethemes.com/bs5/images/logo-dark-text.png" alt="logo"></span>
                    <span class="dark-logo"><img src="https://crypto-admin-templates.multipurposethemes.com/bs5/images/logo-light-text.png" alt="logo"></span>
                </div>
            </a>
        </div>
        <!-- Header Navbar -->
