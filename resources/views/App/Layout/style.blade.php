...
<link rel="stylesheet" href={{asset('/assets/vendor_components/fullcalendar/fullcalendar.print.min.css')}}>;
...
<link rel="stylesheet" href={{asset('/assets/vendor_components/nvd3/nv.d3.min.css')}}>

<!-- Style-->
<link rel="stylesheet" href={{asset('/assets/css/style.css')}}>
<link rel="stylesheet" href={{asset('/assets/css/style_rtl.css')}}>
<link rel="stylesheet" href={{asset('/assets/css/skin_color.css')}}>
<link rel="stylesheet" href={{asset('/assets/css/color_theme.css')}}>
<link rel="stylesheet" href={{asset('/public/assets/css/style_rtl.css')}}>
<link rel="stylesheet" href={{asset('/public/assets/icons/font-awesome-6/css/all.css')}}>
<link rel="stylesheet" href={{asset('/public/assets/icons/font-awesome/css/font-awesome.css')}}>
<link rel="stylesheet" href={{asset('/public/assets/icons/Ionicons/css/ionicons.css')}}>
<link rel="stylesheet" href={{asset('/public/assets/icons/themify-icons/themify-icons.css')}}>
<link rel="stylesheet" href={{asset('/public/assets/icons/linea-icons/linea.css')}}>
<link rel="stylesheet" href={{asset('/public/assets/icons/glyphicons/glyphicon.css')}}>
<link rel="stylesheet" href={{asset('/public/assets/icons/flag-icon-css/css/flag-icon.css')}}>
<link rel="stylesheet" href={{asset('/public/assets/icons/material-design-iconic-font/css/materialdesignicons.css')}}>
<link rel="stylesheet" href={{asset('/public/assets/icons/simple-line-icons/css/simple-line-icons.css')}}>
<link rel="stylesheet" href={{asset('/public/assets/icons/cryptocoins-master/cryptocoins.css')}}>
<link rel="stylesheet" href={{asset('/public/assets/icons/weather-icons/css/weather-icons.min.css')}}>
<link rel="stylesheet" href={{asset('/public/assets/icons/iconsmind/style.css')}}>
<link rel="stylesheet" href={{asset('/public/assets/icons/icomoon/style.css')}}>
<link rel="stylesheet" href={{asset('/public/assets/vendor_components/animate/animate.css')}}>
